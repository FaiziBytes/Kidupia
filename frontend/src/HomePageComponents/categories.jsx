...
//   return (
//     <div className='flex py-10 px-5 justify-between object-contain'>
//       <div className='w-[25%]'>
//         <h1 className='text-[17px] underline text-[#E94A85] font-medium'>CATEGORIES</h1>
//         <div className='text-4xl font-normal mt-4'>
//           <h1>Browsing Top</h1>
...
//             w-[24%] border border-[#E5E5E5] rounded-[6px] hover:shadow-md transition-transform`}
//           >
//             <img src={cat.image} alt={cat.name} className='w-full h-auto rounded-t-[6px]' />
//             <div className='pl-3'>
//               <h1 className='text-[18px] font-medium'>{cat.name}</h1>
...
//   return (
//     <div className='flex flex-col lg:flex-row py-10 px-5 gap-8 lg:justify-between'>
...
//       <div className='w-full lg:w-[72%] grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-7'>
//         {categories.map((cat, index) => (
//           <div
//             key={index}
//             className={`${index === 3 ? 'hidden xl:block' : ''} border border-[#E5E5E5] rounded-[6px] hover:shadow-md hover:scale-105 transition-transform`}
//           >
//             <img src={cat.image} alt={cat.name} className='w-full h-auto rounded-t-[6px]' />
